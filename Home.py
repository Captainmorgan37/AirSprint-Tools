    ...
    return [
        {
            ...
            "links": [
                ...
                {"path": "pages/HOTAC Coverage Monitor.py", "label": "Hotel Booking Monitor"},
        ...
        },
        {
            ...
            "links": [
                ...
                {"path": "pages/Customs Port Finder.py", "label": "Customs Port Finder"},
            ],
        },
        {
            "label": "In Progress",
            ...
            "links": [
                ...
                {"path": "pages/Crew Positioning Monitor.py", "label": "Crew Positioning Monitor"},
                {"path": "pages/Gantt View.py", "label": "Gantt View"},
                {"path": "pages/Crew Availability Finder.py", "label": "Crew Availability Finder"},
            ],
        },
        {
            "label": "🛠️ Diagnostics",
