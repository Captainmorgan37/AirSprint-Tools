...
def test_workflow_validation_supports_ampersand_between_owner_types() -> None:
    quote = _workflow_quote(
        "FEX Guaranteed", "24HR CLUB CJ3 & L450 OWNER REQUESTING CJ3"
    )
...
def test_workflow_validation_supports_owner_lines_without_club_keyword() -> None:
    quote = _workflow_quote(
        "FEX Guaranteed",
        "11JUN CYYC - KLAX [One-way]\n-\n24hr CJ2 owner requesting CJ2",
    )
...
def test_weight_balance_counts_animals_as_cargo() -> None:
    payload = {
        ...
        "cargo": [
            {"weightQty": 100, "note": "Luggage"},
        ],
        "animal": [
            {"weightQty": 19, "note": "Archie the dog"},
            {"weightQty": 49, "note": "Jet the dog"},
        ],
    }
